...
1. To create a React Application with the name of “myfirstreact”, type the following command:

`npx create-react-app myfirstreact`

2. Open the folder of myfirstreact in Visual Studio Code

3. Open the App.js file in Src Folder of myfirstreact

4. Remove the current content of “App.js”
...
6. Run the following command to execute the React application:

`npm start`

7. Open a new browser window and type “localhost:3000” in the address bar
